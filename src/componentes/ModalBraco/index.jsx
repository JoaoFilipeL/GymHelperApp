...
import './ModalBraco.css';

export default function ModalBraco({ onSave, onClose, treino }) {
    ...
    const confirmModal = () => {
        if (exercicios.length > 0) {
            onSave({
                nome: treino ? treino.nome : 'Treino de Braço', 
    ...
    return (
        <div className="backdrop-ModalBraco">
            <div className="dentro-ModalBraco">
                <h2 className='titulo-ModalBraco'>{treino ? treino.nome : 'Novo Treino de Braço'}</h2>
