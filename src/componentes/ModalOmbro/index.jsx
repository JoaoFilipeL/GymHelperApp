...
import './ModalOmbro.css';

export default function ModalOmbro({ onSave, onClose, treino }) {
    ...
    const confirmModal = () => {
        if (exercicios.length > 0) {
            onSave({
                nome: treino ? treino.nome : 'Treino de Ombro', 
    ...
    return (
        <div className="backdrop-ModalOmbro">
            <div className="dentro-ModalOmbro">
                <h2 className='titulo-ModalOmbro'>{treino ? treino.nome : 'Novo Treino de Ombro'}</h2>
