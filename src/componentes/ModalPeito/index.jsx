...
import './ModalPeito.css';

export default function ModalPeito({ onSave, onClose, treino }) {
    ...
    const confirmModal = () => {
        if (exercicios.length > 0) {
            onSave({
                nome: treino ? treino.nome : 'Treino de Peito', 
    ...
    return (
        <div className="backdrop-ModalPeito">
            <div className="dentro-ModalPeito">
                <h2 className='titulo-ModalPeito'>{treino ? treino.nome : 'Novo Treino de Peito'}</h2>
